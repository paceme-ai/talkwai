    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p className="mb-4">
            TalkwAI ("we," "our," or "us") is committed to protecting your
            privacy. This Privacy Policy explains how we collect, use, disclose,
            and safeguard your information when you use our AI-powered call
            handling and automation services.
          </p>
          <p className="mb-4">
            By using our services, you consent to the data practices described
            in this policy. If you do not agree with this policy, please do not
            use our services.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Configuration Data:</strong> Settings, preferences, and
              customizations for your AI assistant
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              ...
              timestamps, call recordings, and transcriptions
            </li>
            <li>
            ...
            <li>
              <strong>Analytics Data:</strong> Service performance, error
              reports, and usage patterns
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            connect to TalkwAI, such as CRM systems, calendar applications, or
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              ...
              improve our AI call handling services
            </li>
            <li>
              <strong>AI Training:</strong> To train and improve our AI models
            ...
            <li>
              ...
              responses, and important notices
            </li>
            <li>
            ...
            <li>
              <strong>Business Operations:</strong> For billing, account
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            who assist us in operating our services, such as cloud hosting,
            payment processing, and analytics providers.
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              ...
              rest using advanced encryption standards
            </li>
            <li>
            ...
            <li>
              ...
              response and breach notification procedures
            </li>
          </ul>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Call Recordings:</strong> Retained according to your
              settings and legal requirements (typically 30-90 days)
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            To exercise these rights, please contact us at privacy@talkwai.com.
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p>
              <strong>TalkwAI Privacy Team</strong>
            </p>
