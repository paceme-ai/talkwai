    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p className="mb-4">
            By accessing and using TalkwAI's services, you accept and agree to be bound by the terms and provision of this agreement. 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            TalkwAI provides AI-powered call handling and automation services for businesses. Our services include but are not limited to:
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            You agree not to use TalkwAI's services to:
          </p>
          <ul className="list-disc pl-6 mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Payment for TalkwAI services is due according to the billing schedule selected during registration. 
            We reserve the right to suspend or terminate services for non-payment. All fees are non-refundable 
            unless otherwise specified in writing.
          </p>
          <p className="mb-4">
            We may change our pricing at any time with 30 days' notice to existing customers. 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            You retain ownership of your data. We process your data solely to provide our services and as 
            described in our Privacy Policy. We implement industry-standard security measures to protect your data.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            TalkwAI and its licensors own all rights, title, and interest in and to the service, including all 
            intellectual property rights. You may not copy, modify, distribute, sell, or lease any part of our 
            services or included software.
          </p>
          <p className="mb-4">
            You grant us a limited license to use, store, and process your content solely for the purpose of 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We are not liable for any damages resulting from service interruptions, including but not limited 
            to lost revenue, data, or business opportunities.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, TALKWAI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            where TalkwAI is incorporated, without regard to its conflict of law provisions.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            via email or through our service. Continued use of our services after changes constitutes acceptance 
            of the new Terms.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p><strong>TalkwAI Support</strong></p>
